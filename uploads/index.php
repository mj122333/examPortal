...
<body>
  ...
  <script>
    ...
    function loadQuestion() {
      ...
      // Provjeri postoji li slika uz pitanja
      ...
      // Dohvati indeks točnog odgovora
      const correctAnswerIndex = parseInt(currentQuestion.correctAnswer);
      
      // Kreiraj polje indeksa odgovora i miješaj ih
      let answerIndices = [];
      ...
      // Mapiranje originalnih indeksa na pomiješane indekse
      // Prati gdje će biti točan odgovor nakon miješanja
      let newCorrectIndex = null;
      
      // Dodaj gumbe s odgovorima u randomiziranom poretku
      answerIndices.forEach((originalIndex, newIndex) => {
        const answer = answersArray[originalIndex];
        
        // Zabilježi novi indeks točnog odgovora
        ...
        if (answer && answer.trim() !== '') {
          ...
          // Točan odgovor je onaj čiji je originalni indeks bio jednak correctAnswerIndex
          button.dataset.correct = (originalIndex === correctAnswerIndex).toString();
