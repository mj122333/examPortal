...
<body>
  ...
  <script>
    ...
    function selectAnswer(e) {
      ...
      // Označimo samo odabrani odgovor (bez točno/netočno indikacije)
      selectedButton.style.backgroundColor = "#6c757d"; // Ističemo samo odabrani odgovor
      selectedButton.style.color = "#fff";
      selectedButton.style.borderColor = "#6c757d";
      
      // Onemogući sve gumbe nakon odgovora
      const allButtons = document.querySelectorAll('.answer-btn');
      allButtons.forEach(button => {
        button.disabled = true;
      });
      
      // Pusti zvučni efekt za odabir (ne otkrivamo je li točno)
    ...
    function endQuiz() {
      ...
      for (let i = 0; i < questions.length; i++) {
        ...
        hiddenField.name = 'question' + i;
        hiddenField.value = userAnswers[i] ? userAnswers[i].selectedAnswer : '';
        form.appendChild(hiddenField);
      }
      
      // Dodaj polje za temu (ako postoji u URL-u)
